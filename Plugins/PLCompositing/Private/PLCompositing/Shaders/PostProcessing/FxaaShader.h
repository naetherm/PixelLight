...
// Source: "FxaaSamplePack.zip" (https://docs.google.com/leaf?id=0B2manFVVrzQAMzUzYWQ5MTEtYmE1NC00ZTQzLWI2YWYtNTk2MDcyMmY1ZWNm&sort=name&layout=list&num=50&pli=1)
// [CHANGED] Put the source code into a C-string by adding "\n\"

// Divided into two parts because I got the following VC compiler error: "error C2026: string too big, trailing characters truncated"
static const PLCore::String sEndFXAA_FS_Part1 = "\
/*============================================================================\n\
									API PORTING\n\
============================================================================*/\n\
...
static const PLCore::String sEndFXAA_FS = sEndFXAA_FS_Part1 + sEndFXAA_FS_Part2;
